...
class pure_moon():
    ...
    def __init__(cls):
        ...
        # 绝对路径前缀
        cls.path_prefix = '/Users/chenzongwei/pythoncode/数据库/'
        # 股票代码文件
        cls.codes_path = '日频数据/AllStockCode.mat'
        # 交易日期文件
        cls.tradedays_path = '日频数据/TradingDate_Daily.mat'
        # 上市天数文件
        cls.ages_path = '日频数据/AllStock_DailyListedDate.mat'
        # st日子标志文件
        cls.sts_path = '日频数据/AllStock_DailyST.mat'
        # 交易状态文件
        cls.states_path = '日频数据/AllStock_DailyStatus.mat'
        # 复权开盘价数据文件
        cls.opens_path = '日频数据/AllStock_DailyOpen_dividend.mat'
        # 复权收盘价数据文件
        cls.closes_path = '日频数据/AllStock_DailyClose_dividend.mat'
        #复权最高价数据文件
        cls.highs_path = '日频数据/Allstock_DailyHigh_dividend.mat'
        #复权最低价数据文件
        cls.lows_path = '日频数据/Allstock_DailyLow_dividend.mat'
        # 不复权收盘价数据文件
        cls.pricloses_path = '日频数据/AllStock_DailyClose.mat'
        # 流通股本数据文件
        cls.flowshares_path = '日频数据/AllStock_DailyAShareNum.mat'
        # 成交量数据文件
        cls.amounts_path = '日频数据/AllStock_DailyVolume.mat'
        # 换手率数据文件
        cls.turnovers_path = '日频数据/AllStock_DailyTR.mat'
        # 因子数据文件
        cls.factors_file = ''
        # 已经算好的月度st状态文件
        cls.sts_monthly_file = '日频数据/sts_monthly.feather'
        # 已经算好的月度交易状态文件
        cls.states_monthly_file = '日频数据/states_monthly.feather'
        # 已经算好的月度st_by10状态文件
        cls.sts_monthly_by10_file = '日频数据/sts_monthly_by10.feather'
        # 已经算好的月度交易状态文件
        cls.states_monthly_by10_file = '日频数据/states_monthly_by10.feather'
        # 拼接绝对路径前缀和相对路径
        dirs = dir(cls)
...
class pure_winter():
    def __init__(self):
        # barra因子数据
        self.barras = self.read_h5('/Users/chenzongwei/pythoncode/数据库/barra数据/FactorLoading_Style.h5')
        # 行业哑变量数据
        self.industrys = self.read_h5('/Users/chenzongwei/pythoncode/数据库/barra数据/FactorLoading_Industry.h5')
